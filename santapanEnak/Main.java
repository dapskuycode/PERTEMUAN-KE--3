       ...
       try {
          // Meminta input dari pengguna
            ...
            // TO DO 5: Tampilkan pesan bahwa menu tidak valid dan menghentikan eksekusi program
                assert (pilihanMenu == 1 || pilihanMenu == 2) : "Pesanan tidak valid";
            }
        ...
        } catch (MenuTidakTersediaException | JumlahPesananMelebihiStokException ase) {
            System.out.println("Terjadi kesalahan: " + ase.getMessage());
        } finally {
            scanner.close();
        }
    }
